    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                return [4 /*yield*/, db_1.USERS.findOne({ username: username, password: password })];
            case 1:
                user = _b.sent();
                if (user) {
                    token = (0, middlewares_1.generatetoken)(user);
        ...
        switch (_b.label) {
            ...
            case 1:
                ...
                if (user) {
                    ...
                    newuser = new db_1.USERS({ username: username, password: password });
                    newuser.save();
                    token = (0, middlewares_1.generatetoken)(user);
                    res.json({ message: token });
                }
